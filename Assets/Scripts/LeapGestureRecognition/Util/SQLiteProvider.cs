...
namespace LeapGestureRecognition
{
	public class SQLiteProvider
	{
				...
				using (SQLiteCommand command = new SQLiteCommand(sql, connection))
				{
					using (SQLiteDataReader reader = command.ExecuteReader())
					{
						while (reader.Read())
						{
							...
							ColorUtility.TryParseHtmlString(reader.GetString(1),out color);
		...
		public List<SGInstanceWrapper> GetStaticGestureInstances(int classId)
		{
			var gestureInstances = new List<SGInstanceWrapper>();
		...
		public List<SGClassWrapper> GetAllStaticGestureClasses()
		{
			var gestures = new List<SGClassWrapper>();
		...
		public List<DGInstanceWrapper> GetDynamicGestureInstances(int classId)
		{
			var gestureInstances = new List<DGInstanceWrapper>();
		...
		public List<DGClassWrapper> GetAllDynamicGestureClasses()
		{
			var gestures = new List<DGClassWrapper>();
